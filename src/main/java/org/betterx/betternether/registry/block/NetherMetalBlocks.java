...
public class NetherMetalBlocks {
    ...
    public static final Block CINCINNASITE_PILLAR = NetherBlocks.defineBlock(
                                                                        "cincinnasite_pillar",
                                                                ...
                                                                .addTrait(NetherLoot.dropSelfNoExplosion())
                                                                .buildAndRegister();
    public static final Block CINCINNASITE_BRICKS = NetherBlocks.defineBlock("cincinnasite_bricks", Block::new)
                                                                .addTrait(NetherMaterial.cincinnasite())
                                                                .strength(3.0F, 10.0F)
                                                                .sound(SoundType.IRON)
                                                                .addTrait(ModelTraitLibrary.cube())
                                                                ...
                                                                .addTrait(NetherLoot.dropSelfNoExplosion())
                                                                .buildAndRegister();
    public static final Block CINCINNASITE_BRICK_PLATE = NetherBlocks.defineBlock(
                                                                     ...
                                                                     .addTrait(NetherLoot.dropSelfNoExplosion())
                                                                     .buildAndRegister();
    public static final Block CINCINNASITE_STAIRS = NetherBlocks.defineBlock(
                                                                        "cincinnasite_stairs",
                                                                ...
                                                                .buildAndRegister();
    public static final Block CINCINNASITE_SLAB = NetherBlocks.defineBlock("cincinnasite_slab", SlabBlock::new)
                                                              .replacePropertiesWithCopy(CINCINNASITE_FORGED)
    ...
    public static final Block CINCINNASITE_BUTTON = NetherBlocks.defineBlock(
                                                                        "cincinnasite_button",
    ...
    public static final Block CINCINNASITE_PLATE = NetherBlocks.defineBlock(
                                                                       "cincinnasite_plate",
                                                               ...
                                                               .buildAndRegister();
    public static final Block CINCINNASITE_TILE_LARGE = NetherBlocks.defineBlock("cincinnasite_tile_large", Block::new)
                                                                    .addTrait(NetherMaterial.cincinnasite())
                                                                    .strength(3.0F, 10.0F)
                                                                    .sound(SoundType.IRON)
                                                                    .mapColor(MapColor.COLOR_YELLOW)
                                                                    .addTrait(NetherLoot.dropSelfNoExplosion())
                                                                    .buildAndRegister();
    public static final Block CINCINNASITE_TILE_SMALL = NetherBlocks.defineBlock("cincinnasite_tile_small", Block::new)
                                                                    .addTrait(NetherMaterial.cincinnasite())
                                                                    .strength(3.0F, 10.0F)
                                                                    .sound(SoundType.IRON)
                                                                    .mapColor(MapColor.COLOR_YELLOW)
                                                                    .addTrait(NetherLoot.dropSelfNoExplosion())
                                                                    .buildAndRegister();
    public static final Block CINCINNASITE_CARVED = NetherBlocks.defineBlock("cincinnasite_carved", Block::new)
                                                                .addTrait(NetherMaterial.cincinnasite())
                                                                .strength(3.0F, 10.0F)
                                                                .sound(SoundType.IRON)
                                                                .mapColor(MapColor.COLOR_YELLOW)
                                                                .addTrait(NetherLoot.dropSelfNoExplosion())
                                                                .buildAndRegister();
    public static final Block CINCINNASITE_WALL = NetherBlocks.defineBlock("cincinnasite_wall", WallBlock::new)
                                                              .replacePropertiesWithCopy(CINCINNASITE_FORGED)
    ...
    public static final Block NETHER_RUBY_BLOCK = NetherBlocks.defineBlock("nether_ruby_block", Block::new)
                                                              ...
                                                              .addTrait(NetherLoot.dropSelfNoExplosion())
                                                              .buildAndRegister();
    public static final Block NETHER_RUBY_STAIRS = NetherBlocks.defineBlock(
                                                                       "nether_ruby_stairs",
                                                               ...
                                                               .buildAndRegister();
    public static final Block NETHER_RUBY_SLAB = NetherBlocks.defineBlock("nether_ruby_slab", SlabBlock::new)
                                                             .replacePropertiesWithCopy(NETHER_RUBY_BLOCK)
                                                             .addTrait(BlockTraits.SLAB_BLOCK.withDefault())
                                                             .addTrait(NetherModels.slabColumnDouble(
