...
//	public static final Tag<Block> MYCELIUM = TagAPI.makeCommonBlockTag("nether_mycelium");
    ...
    public static final TagAPI.TagLocation<Block> NETHER_FARMLAND_LOCATION = new TagAPI.TagLocation<>("c",
            "nether_farmland");
    ...
    public static void register() {
        ...
        TagAPI.addBlockTag(NamedCommonBlockTags.IS_OBSIDIAN, Blocks.OBSIDIAN, Blocks.CRYING_OBSIDIAN);
